        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg font-semibold text-gray-800">Release List</h3>
                    <a href="{{ route('warehouse.release.create') }}" class="bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition">
                        + New Release
                    </a>
                </div>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach($releases as $release)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-600">{{ $release->total_quantity }}</td>
